...
- **Boxes**: There are two types of boxes used to show information:
  - `\begin{warning}{title} content \end{warning}` denotes a warning
  - `\begin{hint}{title} content \end{content}` denotes a hint used to give additional information to the students
